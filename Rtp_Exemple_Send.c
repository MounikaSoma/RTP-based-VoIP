...
int main(int argc, char *argv[])
{
    ...
    char buf[BUFSIZE];
    context cid;// its a dtaatype defined in RTP library
    u_int32     period;
    u_int32     t_inc;
    u_int16     size_read;
    ...
    Init_Socket();
    RTP_Create(&cid); //creates an instance of RTP
    ...
    pa_simple *recordStream = NULL; //creates an audio stream
    int error;
    // records the audio stream
    ...
    // sending the recorded voice packet
    while(1)
    {
